...
<html lang="en">
<head>
  <title>Search Update Movie</title>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="wrapper">
    <div class="content">
        <h1>Update Movie </h1>
        <p>Please give a movie title to update</p>
    </div>
    <div class="form">
      <form action = 'updateMovie.php' method='post'>
        <div class="middle-form">
          <div class="inner-form">
            ...
            <input type="text" placeholder="..." name = 'titleToUpdate'>
          </div>
        </div></br>
        <button class="btn peach-gradient btn-lg float-right" type="submit">confirm</button>
      </form>
     </br></br>
