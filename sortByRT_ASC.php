<html lang="en">
<head>
  <title>Search by rotten tomatoes</title>
  <meta charset="utf-8">
...
<?php include('head.php');
      session_start();?>
  <body>
    <h2>Show all data by rotten tomatoes rating in ascending order</h2>
    ...
    <div id="result">
        ...
        <thead class="thead-dark">
            ...
            <?php
                ...
                $result = mysqli_query($db_connection,"SELECT rating.id, rating.rotten_tomatoes, movie.title FROM rating LEFT JOIN movie ON rating.id = movie.id ORDER BY rating.rotten_tomatoes ASC");
