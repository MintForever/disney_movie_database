    ...
    <div id="result">
        ...
        <thead class="thead-dark">
            ...
            <?php
                ...
                $result = mysqli_query($db_connection,"SELECT rating.id, rating.rotten_tomatoes, movie.title FROM rating LEFT JOIN movie ON rating.id = movie.id ORDER BY rating.rotten_tomatoes DESC");
